...
JS,
                                        ...
                                        [
                                            ...
                                            'entrada'=>[
                                                'tipo'=>'hidden',
                                                // 'opciones'=>['grupo1'=>'grupo1','grupo2'=>'grupo2'],
                                                'label'=> 'Grupo'
                                            ],
                                            'render'=>
<<<JS
                                                var html='';
                                                for(var i in data){
                                                    html+=(html!=''?'<br>':'')+'<a href="$base_url/grupos/modificar_grupo?grp='+data[i].id_grupo+'">'+data[i].desc_grupo+'</a>';
                                                }
                                                return html;
JS,                                        ],
                                    ],

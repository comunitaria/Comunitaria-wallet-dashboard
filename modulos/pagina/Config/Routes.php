...
$routes->get('/grupos', '\Modulos\Pagina\Controllers\Grupos::index'); //Vpconf: ['grupos','meBucP','2']

$routes->post('/usuarios/modificar', '\Modulos\Pagina\Controllers\Usuarios::modificar');

$routes->post('/grupos/crear_oficio', '\Modulos\Pagina\Controllers\Grupos::crear_oficio');
$routes->post('/grupos/modificar_oficio', '\Modulos\Pagina\Controllers\Grupos::modificar_oficio');
$routes->post('/grupos/eliminar_oficio', '\Modulos\Pagina\Controllers\Grupos::eliminar_oficio');
$routes->post('/grupos/crear', '\Modulos\Pagina\Controllers\Grupos::crear');
$routes->post('/grupos/modificar', '\Modulos\Pagina\Controllers\Grupos::modificar');
$routes->post('/grupos/eliminar', '\Modulos\Pagina\Controllers\Grupos::eliminar');
$routes->get('/grupos/modificar_grupo', '\Modulos\Pagina\Controllers\Grupos::modificar_grupo');
$routes->post('/grupos/modificar_grupo', '\Modulos\Pagina\Controllers\Grupos::modificar_grupo');
$routes->post('/grupos/eliminar_usuarios', '\Modulos\Pagina\Controllers\Grupos::eliminar_usuarios');

$routes->post('/grupos/usuariossingrupo', '\Modulos\Pagina\Controllers\Grupos::usuariosSinGrupo');

$routes->get('/grupos/anadirUsuariosAlGrupo', '\Modulos\Pagina\Controllers\Grupos::anadirUsuariosAlGrupo');
$routes->post('/grupos/anadirUsuariosAlGrupo', '\Modulos\Pagina\Controllers\Grupos::anadirUsuariosAlGrupo');
...
$routes->post('/historico/expedientes', '\Modulos\Pagina\Controllers\Historico::expedientes'); 
...
$routes->post('/comercio/prelogo/(:num)', '\Modulos\Pagina\Controllers\Comercio::prelogo/$1'); //Vpconf: ['EditarComercio','eBup','2']

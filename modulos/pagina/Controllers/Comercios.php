...
//Vpconf<
        ...
        public function crear(){
            log_message('debug','creando comercio');
            if (!tienePermiso([2])) return view('no_autorizado');
            ...
            if (!is_null($hayBeneficiario)||!(is_null($hayComercio))){
                ...
                log_message('debug','creando comercio va a insertar');
                if (!$db->table('comercios')->ignore(true)->insert([
                    ...
                    log_message('debug','fallo '.$respuesta['mensaje']);
                }
                else{

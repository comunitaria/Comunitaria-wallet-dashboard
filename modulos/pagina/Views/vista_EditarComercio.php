                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="email" class="form-control" id="ipTelefono" name="ipTelefono" value="<?= $comercio['movil'] ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-3">
                                        ...
                                        <figure class="mw-100 mb-0 d-flex">
                                            <img src="<?= $comercio['imgLogo'] ?>" alt="Avatar" id="ipImgLogo" class="border mx-auto my-auto" style="padding-top:20px;width:15rem" />

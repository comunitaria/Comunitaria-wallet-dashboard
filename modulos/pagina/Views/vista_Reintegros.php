...
<<<JS
                        ...
                        <div class="card card-widget widget-user-2">
                            <div class="widget-user-header bg-success">
                                ...
                                <h5 class="widget-user-desc">`+row['Clases'].replace('#-#', ', ')+`</h5>
                            </div>
                            <div class="card-footer py-0">
                                <div class="row mt-4">
                                    ...
                                    <div class="col-lg-6 my-2">`+                                                                                                                                                                   
                                            (row['Monedero']==$cuentaAutorizada?'<i class="text-primary fas fa-wallet"></i><span class="pl-2">Monedero operativo</span>':'<i class="text-danger fas fa-wallet"></i><span class="pl-2">'+(row['Monedero']==$cuentaNoCreada?'Esperando que el usuario abra monedero':
                                ...
                                <div class="row mt-4">
                                    <dl class="col-lg-6">
                                        <dt>Dirección</dt>
                                        <dd><small id="dgCuenta">`+(row['Dirección']==''?'No registrada':row['Dirección'])+`</small></dd>
                                    </dl>
                                    <dl class="col-lg-6">
                                        <dt>Contacto</dt>
                                        <dd class="my-0"><small id="dgCuenta">`+(row['Contacto']==''?'No registrado':row['Contacto'])+`</small></dd>
                                        <dd class="my-0"><small id="dgCuenta"><i class="fas fa-phone"></i> `+(row['Movil']==''?'No registrado':row['Movil'])+`</small></dd>
                                        <dd><small id="dgCuenta"><i class="fas fa-envelope"></i> `+(row['Correo']==''?'No registrado':row['Correo'])+`</small></dd>
                                        <dt>Usuario</dt>
                                        <dd><small id="dgCuenta">`+row['Usuario']+`</small></dd>
                                    </dl>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <dl>
                                        <dt>Cuenta</dt>
                                        <dd><small id="dgCuenta">`+(row['Clave']==''?'No creada':row['Clave'])+`</small></dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
